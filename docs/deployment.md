...
- **Global install:**
  ...
  npm install -g @dreadnode/spyglass-agent-cli
...
- **NPX execution:**
  ...
  npx @dreadnode/spyglass-agent-cli
  ```
...
- `@dreadnode/spyglass-agent-core`: The backend, handling logic and tool execution.
- `@dreadnode/spyglass-agent-cli`: The user-facing frontend.
