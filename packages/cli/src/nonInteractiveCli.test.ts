...
import { Config, GeminiClient, ToolRegistry } from '@dreadnode/spyglass-agent-core';
import { GenerateContentResponse, Part, FunctionCall } from '@google/genai';

// Mock dependencies
vi.mock('@dreadnode/spyglass-agent-core', async () => {
  const actualCore = await vi.importActual<
    typeof import('@dreadnode/spyglass-agent-core')
  >('@dreadnode/spyglass-agent-core');
  return {
    ...actualCore,
    GeminiClient: vi.fn(),
    ToolRegistry: vi.fn(),
