...
```bash
git clone https://github.com/dreadnode/spyglass-agent.git # Or your fork's URL
cd gemini-cli
```
...
- Consult [SPYGLASS.md](https://github.com/dreadnode/spyglass-agent/blob/main/SPYGLASS.md) (typically found in the project root) for specific instructions related to AI-assisted development, including conventions for React, comments, and Git usage.
